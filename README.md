...
*原型版本：v2.0.7 | 2026-06-20 | XCMG 设备运维监控平台 · 中英双语 · 事件中心支持手动新建事件 · 设备主数据导入管理 · 二级菜单视觉强化 · MineCare/运营指标表新增导入按钮 · 侧边栏新增「地图视图」一级入口（map.html）· 告警详情新增「去知识库」按钮（折叠展开 9 大 tab + X-GSS 跳转）*
